...
void GetTargetTiles(int finder, int& Target1, int& Target2, int& Target3, int Target,Grid global_grid,Grid g1, Grid g2, Grid g3)
{
    Tile* Target_Tile;
    Tile* Neighb_Tile;
    Tile* Neigh_Neighb_Tile;
